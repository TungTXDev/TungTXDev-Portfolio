...
const MeteorGame = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="relative bg-[#1e1e1e] rounded-xl shadow-2xl overflow-hidden" style={{ maxWidth: '1200px', width: '100%' }}>
                ...
                <div className="h-12 bg-[#323233] flex items-center px-4 border-b border-[#2d2d30]">
                    ...
                    <div className="flex-1 text-center">
                        <span className="text-[#cccccc] text-sm font-medium">🎮 Meteor Dodge</span>
                    </div>
                        ...
                        {gameState === 'ready' && (
                            <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                                <div className="text-center space-y-6">
                                    ...
                                    <h3 className="text-3xl font-bold text-white">Meteor Dodge</h3>
                                    ...
                                    <div className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-900/30 to-pink-900/30 backdrop-blur-sm rounded-xl border border-purple-500/30">
                                        ...
                                        <kbd className="px-3 py-2 bg-white/10 rounded-lg text-white text-lg font-mono border border-white/20">←</kbd>
                                        <kbd className="px-3 py-2 bg-white/10 rounded-lg text-white text-lg font-mono border border-white/20">→</kbd>
